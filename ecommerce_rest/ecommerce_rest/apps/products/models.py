...
class MeasureUnit(BaseModel):
    ...
    description = models.CharField('Descripción', max_length=50,blank = False,null = False,unique = True) #blank: Espacio en blanco
    historical = HistoricalRecords()

    #Property registra que usuario realizo un cambio
    @property
